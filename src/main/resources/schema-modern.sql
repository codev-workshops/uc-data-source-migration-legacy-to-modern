...
-- MODERN SCHEMA
-- =============================================================================
-- Normalized, typed replacement for the legacy CDW tables.
-- Based on data/modern-schema/modern_tables.sql, plus payments.external_id which
-- carries the legacy PMT_SEQ_NBR so the API can keep exposing the legacy
-- payment identifier without leaking the BIGINT surrogate key.
-- =============================================================================
...
CREATE TABLE payments (
    id                  BIGINT PRIMARY KEY AUTO_INCREMENT,
    external_id         VARCHAR(20) NOT NULL UNIQUE,   -- legacy PMT_SEQ_NBR
